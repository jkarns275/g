...
impl GraphicsMode {
    const GRAPHICS_MODE_ADDR: Ptr<u16> = Ptr::from_u32(0x04000000);
    ...
    pub fn current() -> GraphicsMode {
        unsafe { GraphicsMode::from_u16(mem::transmute(*GraphicsMode::GRAPHICS_MODE_ADDR)) }
    }
...
impl Default for GraphicsMode {
    fn default() -> Self {
        GraphicsMode {
            ...
            window0_enabled:        true,
            window1_enabled:        true,
            sprite_windows_enabled: true
        }
    }
}